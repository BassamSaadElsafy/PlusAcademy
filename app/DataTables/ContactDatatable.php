...
class ContactDatatable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('phone')                 ->name('phone')        ->data('phone')        ->title('phone')       ->width('20'),
            Column::make('subject')                 ->name('subject')        ->data('subject')        ->title('subject')       ->width('20'),
            Column::make('message')                 ->name('message')        ->data('message')        ->title('message')       ->width('20'),
